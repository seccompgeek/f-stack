...
int ff_epoll_create(int size __attribute__((__unused__))) {
  return ff_kqueue();
}
...
static void ff_event_to_epoll(void **ev, struct kevent *kev) {
...
int ff_epoll_wait(int epfd, struct epoll_event *events, int maxevents,
                  int timeout) {
